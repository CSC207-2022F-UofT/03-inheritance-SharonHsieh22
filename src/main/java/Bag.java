...
public abstract class Bag {
    ...
    public boolean addItem(String item) {
        if (this.numberOfContents < this.capacity) {
            ...
            System.arraycopy(this.contents, 0, newContents, 0, len);
            newContents[len] = item;
     ...
     *
     * @return last item added to this bad or null if the bag is empty.
     */
    public String popItem() {
        ...
        String[] newContents = new String[len - 1];
        System.arraycopy(this.contents, 0, newContents, 0, len - 1);
        String lastItem = this.contents[len - 1];
        this.contents = newContents;
        this.numberOfContents -= 1;
        return lastItem;
    }
     ...
     *
     * @return the color of the bag with the number of contents inside it and its capacity.
     */
    @Override
